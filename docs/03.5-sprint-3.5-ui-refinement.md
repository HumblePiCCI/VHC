...
**Status:** 🔄 **IN PROGRESS** | **Predecessor:** Sprint 3 ✅
**Goal:** Polish HERMES Messaging + Forum UI/UX before Sprint 4
**Current Phase:** Phase 7.1 — Threaded Comment Stream + Slide-to-Post (Dec 12, 2025)
...
- [x] **LOC Cap:** 350 lines/file ✅ (max 315 lines — CommentStream.tsx)
- [x] **Coverage:** 100% Line/Branch/Function/Statement ✅ (323 tests)
...
**Test Status:** 323 unit + 10 E2E passing | 100% coverage | CI green ✅
...
**Phase 7.1 (Complete — Threaded CommentStream + SlideToPost, Dec 12, 2025):**
...
- [x] **Tree Connectors:** Stance-based visual alignment:
  ...
  - Discuss: Centered, vertical line between cards
  - Oppose (counter): Right-aligned, connectors on right edge
- [x] Card border radius matches connector side (rounded-r/l/full) ✅
- [x] Progressive indentation: 0 → 28px → 48px → 60px (capped at depth 3+) ✅
- [x] Card width shrinks with depth: 85% → 80% → 75% → 70% ✅
...
- [x] 323 tests, 100% line/branch/function/statement coverage ✅

---

## 12. Dev Color Panel Reference
